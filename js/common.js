...
let bt_3 = document.querySelector('.add-btn-3');
  ...
  const chkBox6 = document.getElementById('Check8');
	...
	document.querySelectorAll('[data-target]').forEach(function(elem){
		elem.addEventListener('click', function(){
			document.querySelector('event.target.getAttribute(".slide-1")').querySelectorAll('img').forEach(function(el){
				el.click;
			})
		});
	});
